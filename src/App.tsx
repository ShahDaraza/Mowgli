...
function App() {
  ...
  const [ComingSoonTimeLeft, setComingSoonTimeLeft] = useState("");
  const [SoonTimeLeft, setSoonTimeLeft] = useState("");
  ...
  useEffect(() => {
    const updateCountdowns = () => {
      ...
      setComingSoonTimeLeft(calculateTimeLeft(19));
      setSoonTimeLeft(calculateTimeLeft(12));
    };
  ...
  return (
    <div className="bg-black flex justify-center">
      ...
      flex-col max-w-xl">
        ...
        <div className="px-4 z-10">
          ...
          <div className="flex items-center space-x-2 pt-4">
            ...
            <div>
              <p className="text-sm">Mubeen (CEO)</p>
            </div>
          </div>
        ...
        top-glow z-0">
          <div className="absolute top-[2px] left-0 right-0 bottom-0 bg-
          [#1d2025] rounded-t-[46px]">
            ...
            <div className="bg-[#272a2f] rounded-lg px-4 py-2 w-full 
              relative">
                ...
                w-12 h-12" />
                <p className="text-[10px] text-center text-white mt-1">Coming Soon</p>
                <p className="text-[10px] font-medium text-center 
                text-gray-400 mt-2">{ComingSoonTimeLeft}</p>
              </div>
              <div className="bg-[#272a2f] rounded-lg px-4 py-2 w-full 
              relative">
                <div className="dot"></div>
                <img src={dailyCombo} alt="Daily Combo" className="mx-auto 
                w-12 h-12" />
                <p className="text-[10px] text-center text-white mt-1">Soon</p>
                <p className="text-[10px] font-medium text-center 
                text-gray-400 mt-2">{SoonTimeLeft}</p>
              </div>
            </div>
      ...
      <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-
      [calc(100%-2rem)] max-w-xl bg-[#272a2f] flex justify-around items-center 
